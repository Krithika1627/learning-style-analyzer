...
function CellDiagram() {
  return (
    <svg viewBox="0 0 420 280" style={{width:"100%",maxWidth:440,display:"block",margin:"0 auto"}}>
      <ellipse cx="210" cy="140" rx="195" ry="125" fill={BLUE_LIGHT} stroke={BLUE_SOFT} strokeWidth="2" strokeDasharray="7 3"/>
      <ellipse cx="200" cy="130" rx="60" ry="50" fill={BLUE_MID} stroke={BLUE} strokeWidth="2"/>
      <ellipse cx="200" cy="130" rx="28" ry="22" fill={BLUE_SOFT} stroke={BLUE_DARK} strokeWidth="1.5"/>
      <text x="200" y="134" textAnchor="middle" fontSize="9" fill={BLUE_DARK} fontWeight="700">Nucleus</text>
      <text x="200" y="145" textAnchor="middle" fontSize="7" fill={BLUE}>nucleolus</text>
      <ellipse cx="322" cy="98" rx="33" ry="17" fill="#fef9c3" stroke="#ca8a04" strokeWidth="1.5"/>
      <line x1="291" y1="98" x2="355" y2="98" stroke="#ca8a04" strokeWidth="1" strokeDasharray="3 2"/>
      <text x="322" y="102" textAnchor="middle" fontSize="8" fill="#92400e">Mitochondria</text>
      <ellipse cx="112" cy="188" rx="28" ry="14" fill="#fef9c3" stroke="#ca8a04" strokeWidth="1.5"/>
      <text x="112" y="192" textAnchor="middle" fontSize="7.5" fill="#92400e">Mitochondria</text>
      <path d="M265 148 Q285 138 275 162 Q265 182 285 172" fill="none" stroke="#7c3aed" strokeWidth="2"/>
      <text x="297" y="166" fontSize="7.5" fill="#7c3aed">ER</text>
      <path d="M128 100 Q148 95 143 108 Q138 120 158 115 Q178 110 173 123" fill="none" stroke="#16a34a" strokeWidth="2"/>
      <text x="136" y="92" textAnchor="middle" fontSize="8" fill="#15803d">Golgi</text>
      {[{cx:308,cy:150},{cx:250,cy:192},{cx:158,cy:212},{cx:338,cy:172}].map((r,i)=>(
        <circle key={i} cx={r.cx} cy={r.cy} r="5" fill="#fbbf24" stroke="#d97706" strokeWidth="1"/>
      ))}
      <text x="352" y="154" fontSize="6.5" fill={TEXT_MUTED}>Ribosomes</text>
      <ellipse cx="193" cy="215" rx="22" ry="14" fill="#ecfeff" stroke="#0891b2" strokeWidth="1.5"/>
      <text x="193" y="219" textAnchor="middle" fontSize="7.5" fill="#0e7490">Vacuole</text>
      <text x="395" y="34" textAnchor="end" fontSize="8" fill={TEXT_MUTED}>Cell Membrane</text>
      <line x1="368" y1="32" x2="330" y2="18" stroke={BLUE_SOFT} strokeWidth="1"/>
    </svg>
  );
}
...
function BarChart() {
  ...
  const colors = { V: "#2563eb", A: "#0ea5e9", R: "#6366f1", K: "#0891b2" };
...
function Flowchart() {
  return (
    <svg viewBox="0 0 340 295" style={{width:"100%",maxWidth:420,display:"block",margin:"0 auto"}}>
      ...
      <polygon points="170,57 220,79 170,101 120,79" fill={BLUE_LIGHT} stroke={BLUE} strokeWidth="1.5"/>
      ...
      <text x="240" y="75" textAnchor="middle" fontSize="7.5" fill="#16a34a" fontWeight="700">YES</text>
      <rect x="263" y="67" width="62" height="24" rx="6" fill="#dcfce7" stroke="#16a34a" strokeWidth="1.5"/>
      <text x="294" y="79" textAnchor="middle" fontSize="8" fill="#15803d">Connect &amp;</text>
      <text x="294" y="89" textAnchor="middle" fontSize="8" fill="#15803d">Extend</text>
      <line x1="170" y1="101" x2="170" y2="118" stroke={TEXT_MUTED} strokeWidth="1.5" markerEnd="url(#arr)"/>
      <text x="157" y="113" fontSize="7.5" fill="#dc2626" fontWeight="700">NO</text>
      <rect x="115" y="118" width="110" height="26" rx="6" fill={BLUE_MID} stroke={BLUE} strokeWidth="1.5"/>
      <text x="170" y="135" textAnchor="middle" fontSize="8.5" fill={BLUE_DARK} fontWeight="600">Choose a format</text>
      <line x1="170" y1="144" x2="170" y2="160" stroke={TEXT_MUTED} strokeWidth="1.5" markerEnd="url(#arr)"/>
      <polygon points="170,162 220,184 170,206 120,184" fill={BLUE_LIGHT} stroke={BLUE} strokeWidth="1.5"/>
      ...
      <text x="240" y="180" textAnchor="middle" fontSize="7.5" fill="#16a34a" fontWeight="700">YES</text>
      ...
      <text x="157" y="219" fontSize="7.5" fill="#dc2626" fontWeight="700">NO</text>
      <rect x="115" y="223" width="110" height="26" rx="6" fill="#fff7ed" stroke="#f97316" strokeWidth="1.5"/>
      <text x="170" y="240" textAnchor="middle" fontSize="8.5" fill="#9a3412">Try another method</text>
...
function AudioPlayer({ audioText, voiceRate = 0.91, voicePitch = 1 }) {
  ...
  return (
    <div style={{
      background: BLUE_LIGHT, border:`1.5px solid ${BLUE_SOFT}`,
      ...
      <div style={{display:"flex", alignItems:"center", gap:16}}>
        <button onClick={play} style={{
          ...
          boxShadow: playing ? `0 0 0 4px ${BLUE_SOFT}` : "0 2px 8px #2563eb33",
          transition:"all 0.2s"
        }}>
          {playing
        ...
        <div style={{flex:1}}>
          <div style={{display:"flex", justifyContent:"space-between", marginBottom:8}}>
            <span style={{fontSize:12, color: done ? "#16a34a" : BLUE, fontWeight:600}}>
          ...
          <div style={{background: BLUE_SOFT, borderRadius:4, height:6, overflow:"hidden"}}>
            <div style={{
              width:`${progress}%`, height:"100%", borderRadius:4,
              background: done ? "#16a34a" : BLUE,
          ...
          <div style={{display:"flex", alignItems:"flex-end", gap:2, marginTop:8, height:20}}>
            {Array.from({length:40}).map((_,i)=>{
              ...
              return <div key={i} style={{width:4, borderRadius:2, height:h, background: active ? BLUE : BLUE_SOFT, transition:"background 0.1s"}}/>;
            })}
          </div>
        </div>
      </div>
...
function PassageDisplay({ content }) {
  return (
    <div style={{
      ...
      <p style={{fontFamily:"'Georgia','Cambria',serif", fontSize:13.5, lineHeight:1.85, color:TEXT, margin:0}}>
        {content}
      </p>
    </div>
  );
...
function DiagramDisplay({ diagramType }) {
  ...
  return (
    <div style={{background:WHITE, border:`1.5px solid ${BORDER}`, borderRadius:14, padding:"20px 16px"}}>
  ...
  return (
    <button
      ...
      style={{
        ...
        background: isSelected ? BLUE_LIGHT : hovered ? "#f8fafc" : WHITE,
        border:`1.5px solid ${isSelected ? BLUE : hovered ? BLUE_SOFT : BORDER}`,
        boxShadow: isSelected ? `0 0 0 3px ${BLUE_SOFT}` : "0 1px 3px #0001",
    ...
    >
      ...
      <span style={{fontSize:13.5, color: isSelected ? BLUE_DARK : TEXT, lineHeight:1.55, paddingTop:5, fontWeight: isSelected ? 600 : 400}}>
        {opt.text}
      </span>
    </button>
  );
...
function Results({ answers , onGoToTracker }) {
  ...
  // ADD THIS — saves VARK result so StudyTracker can read it
  useEffect(() => {
    const saveVark = async () => {
      try {
        await window.storage.set("st:vark", JSON.stringify(scores));
      } catch (e) {}
    };
    saveVark();
  }, []); // runs once when Results mounts
    ...
    <div style={{maxWidth:620, margin:"0 auto", padding:"0 20px 80px"}}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          color:WHITE, letterSpacing:2, marginBottom:16, textTransform:"uppercase"
        }}>Your Results</div>
        ...
        <p style={{color:"rgba(255,255,255,0.82)", fontSize:14, lineHeight:1.65, maxWidth:420, margin:"0 auto"}}>
          {isMultimodal
      ...
      {/* Score breakdown */}
      <div style={{background:WHITE, border:`1.5px solid ${BORDER}`, borderRadius:16, padding:"24px", marginBottom:20, boxShadow:"0 1px 4px #0000000a"}}>
      ...
      <div style={{background:BLUE_LIGHT, border:`1.5px solid ${BLUE_SOFT}`, borderRadius:16, padding:"24px", marginBottom:20}}>
        <div style={{display:"flex", alignItems:"center", gap:10, marginBottom:14}}>
          <div style={{width:10, height:10, borderRadius:"50%", background:BLUE}}/>
          <span style={{fontSize:12, fontWeight:800, color:BLUE, letterSpacing:1.5, textTransform:"uppercase"}}>
            Primary Style — {labels[dominant]}
          </span>
        </div>
        <p style={{fontSize:13.5, color:TEXT, lineHeight:1.7, margin:"0 0 18px"}}>{descriptions[dominant]}</p>
        <div style={{borderTop:`1px solid ${BLUE_SOFT}`, paddingTop:16}}>
          <p style={{fontSize:11.5, fontWeight:700, color:BLUE_DARK, margin:"0 0 10px", textTransform:"uppercase", letterSpacing:0.8}}>Study Tips</p>
          <div style={{display:"flex", flexDirection:"column", gap:9}}>
            {tips[dominant].map((tip,i) => (
              <div key={i} style={{display:"flex", gap:10, alignItems:"flex-start"}}>
                ...
                <span style={{fontSize:13, color:TEXT, lineHeight:1.55}}>{tip}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
        <button onClick={() => window.location.href = "/tracker"} style={{
        ...
        <button onClick={() => window.location.reload()} style={{
          width:"100%", padding:"15px", borderRadius:12,
          background:"transparent", color:BLUE, fontSize:14, fontWeight:600,
          border:`1.5px solid ${BLUE_SOFT}`, cursor:"pointer"
        }}>
          Retake Assessment
        </button>
      </div>
...
export default function VARKAssessment() {
  ...
  const tagBg   = { "Reading Passage":BLUE_LIGHT, "Audio Clip":"#fff7ed", "Visual Diagram":"#f5f3ff", "Visual Chart":"#f0f9ff", "Scenario":"#f0fdf4" };
  const tagClr  = { "Reading Passage":BLUE, "Audio Clip":"#ea580c", "Visual Diagram":"#7c3aed", "Visual Chart":"#0284c7", "Scenario":"#16a34a" };
  ...
  if (finished) return (
    <div style={{minHeight:"100vh", background:"#f8fafc", paddingTop:48, fontFamily:"'Plus Jakarta Sans','Segoe UI',sans-serif"}}>
      <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800;900&display=swap" rel="stylesheet"/>
      <div style={{textAlign:"center", marginBottom:32}}>
        <div style={{display:"inline-flex", alignItems:"center", gap:8, marginBottom:6}}>
          <div style={{width:8, height:8, borderRadius:"50%", background:BLUE}}/>
          <h1 style={{fontSize:14, fontWeight:800, color:BLUE, margin:0, letterSpacing:2, textTransform:"uppercase"}}>VARK Assessment</h1>
        </div>
        <p style={{fontSize:13, color:TEXT_MUTED, margin:0}}>Assessment complete</p>
      </div>
      <Results answers={answers} onGoToTracker={() => router.push("/tracker")} />
    </div>
  );

  return (
    <div style={{minHeight:"100vh", background:"#f8fafc", fontFamily:"'Plus Jakarta Sans','Segoe UI',sans-serif", color:TEXT}}>
      <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800;900&display=swap" rel="stylesheet"/>
      ...
      <div style={{
        ...
        <div style={{maxWidth:640, margin:"0 auto", padding:"16px 0"}}>
          <div style={{display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:12}}>
            <div>
              <h1 style={{fontSize:15, fontWeight:800, color:BLUE, margin:0, letterSpacing:-0.3}}>VARK Assessment</h1>
              <p style={{fontSize:11, color:TEXT_MUTED, margin:"2px 0 0"}}>Discover your learning style</p>
            </div>
            <div style={{
              background:BLUE_LIGHT, border:`1px solid ${BLUE_SOFT}`,
              borderRadius:8, padding:"5px 12px", fontSize:12, fontWeight:700, color:BLUE
            }}>
              {current + 1} / {questions.length}
            </div>
          </div>
          <div style={{background:"#e2e8f0", borderRadius:6, height:5, overflow:"hidden"}}>
            <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          background:tagBg[q.tag], border:`1px solid ${tagClr[q.tag]}33`,
      ...
      <div style={{
        ...
        <div style={{maxWidth:640, margin:"0 auto", display:"flex", gap:12}}>
          <button onClick={() => navigate("back")} disabled={current === 0} style={{
            ...
            background:WHITE, border:`1.5px solid ${current===0?BORDER:BLUE_SOFT}`,
            color:current===0?TEXT_MUTED:BLUE,
          ...
          <button onClick={() => navigate("next")} disabled={selected === null} style={{
            ...
            background: selected !== null ? BLUE : "#e2e8f0",
            color: selected !== null ? WHITE : TEXT_MUTED,
            fontSize:14, fontWeight:700, cursor:selected===null?"not-allowed":"pointer",
            boxShadow: selected !== null ? "0 4px 16px #2563eb33" : "none",
            transition:"all 0.2s"
          }}>
